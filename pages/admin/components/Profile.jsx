            ...
            <div className='container w-8/12  p-4 '>
                    <div className=' flex px-2 items-center justify-center w-full h-full '>
                        ...
                        <section class="w-64 mx-auto bg-[#20354b] rounded-2xl px-8 py-6 shadow-lg">
                            ...
                            <div class="mt-0 w-fit mx-auto">
                                <img src="https://images.unsplash.com/photo-1628157588553-5eeea00af15c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1160&q=80" class="rounded-full w-28 " alt="profile picture" srcset="" />
                            </div>

                            <div class="mt-8 ">
                                <h2 class="text-white text-center font-bold text-2xl tracking-wide">{name} </h2>
                            </div>
                            <p class="text-emerald-400 text-center font-semibold mt-2.5" >
                                Active
                            </p>
