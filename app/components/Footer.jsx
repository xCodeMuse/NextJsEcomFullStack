...
export default function Footer() {
    return (
      <footer className="container mx-auto px-10 md:px-10 py-10">
      <div className="mb-16 flex flex-col md:flex-row md:items-center justify-between">
        ...
        <div className="grow mt-4 md:mt-0 md:ml-12">
          <p className="font-semibold text-base text-gray-500 dark:text-gray-600">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:space-x-12 w-[100%]">
        <div className="mb-4">
          <h4 className="font-medium text-xl md:text-[26px] md:leading-[30.3px] lg:text-[31px] lg:leading-[40.3px] text-gray-700 dark:text-gray-600">
            Newsletter
          </h4>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 mt-8 lg:mt-0">
          <div className="mb-4">
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-600 mb-6">
              Our Stores
            </p>
